...
async function fetchExpenseRatioFromClaude(ticker, name, apiKey) {
  ...
  const prompt = "What is the current expense ratio for the mutual fund or ETF with ticker \"" + ticker + "\"" + fullName + "? " +
    "Respond with ONLY a JSON object, no other text. Format: " +
    "{\"er\": 0.0039, \"confidence\": \"high\"} " +
    "Where \"er\" is the expense ratio as a decimal (0.0039 means 0.39%). If unknown, use null. " +
